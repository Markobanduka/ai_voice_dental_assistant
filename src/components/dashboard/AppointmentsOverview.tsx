...
async function AppointmentsOverview() {
  ...
  return (
    <Card className="lg:col-span-2">
      <CardHeader>
        ...
        <CardDescription>Keep track of your training sessions</CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Book your first appointment today and join us for an energizing
                workout that will kickstart your fitness journey!
              </p>
